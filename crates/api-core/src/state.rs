// Note: These types are defined in platform-api crate
// They are referenced here but will need to be passed as generic parameters or trait objects
// For now, we'll use type aliases that will be resolved when api-core is used
